...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个大厂程序员，同时也是独立开发者，欢迎来到我的博客🎉',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,程序员,独立开发者', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/simon_xmf27', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/flyrk', // 你的github个人主页 例如 https://github.com/tangly1024
